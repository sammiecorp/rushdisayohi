...
<html lang="tj">
  ...
  <body>
    ...
    <div class="container">
      <a class="navbar-brand" href="index.php"><img src="./images/logo.png" alt="" width="70">Рушди Сайёҳӣ</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item"><a href="index.php" class="nav-link"><strong>Асосӣ</strong></a></li>
          <li class="nav-item active"><a href="about.php" class="nav-link"><strong>Дар бораи</strong></a></li>
          <li class="nav-item"><a href="tour.php" class="nav-link"><strong>Сайёҳат</strong></a></li>
          <li class="nav-item"><a target="blank" href="https://www.booking.com/index.ru.html?label=gen173nr-1DCAEoggI46AdIM1gEaN4BiAEBmAEhuAEXyAEM2AED6AEBiAIBqAIDuAKZ_r2SBsACAdICJGQyYzM2NTU3LTBkN2EtNGM5MS1iYzc0LWFlZjdjNzlmNjhmY9gCBOACAQ;sid=9f3c5b6b7467f8797d5918b1477d8488;keep_landing=1&sb_price_type=total&" class="nav-link"><strong>Меҳмонхонаҳо</strong></a></li>
          
          <li class="nav-item"><a href="contact.php" class="nav-link"><strong>Тамос</strong></a></li>
        </ul>
      </div>
    </div>
  </nav>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/sammie.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php">Асосӣ</a></span>/ <span>Дар бораи</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Дар бораи мо</h1>
          </div>
        </div>
      </div>
    </div>
	    		...
	    		<div class="col-md-6 ftco-animate p-md-5">
		          ...
		          <div class="col-md-12 nav-link-wrap mb-5">
		            <div class="nav ftco-animate nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
		              <a class="nav-link active" id="v-pills-whatwedo-tab" data-toggle="pill" href="#v-pills-whatwedo" role="tab" aria-controls="v-pills-whatwedo" aria-selected="true">Кори мо</a>

		              <a class="nav-link" id="v-pills-mission-tab" data-toggle="pill" href="#v-pills-mission" role="tab" aria-controls="v-pills-mission" aria-selected="false">Миссияи мо</a>

		              <a class="nav-link" id="v-pills-goal-tab" data-toggle="pill" href="#v-pills-goal" role="tab" aria-controls="v-pills-goal" aria-selected="false">Мақсади мо</a>
		            </div>
		          </div>
